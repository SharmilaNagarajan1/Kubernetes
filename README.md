...
# Replication Controller - Ensures a specified number of identical pods are running at all times (legacy feature).
...
# ReplicaSet - A newer controller that maintains a stable set of replica pods, replacing ReplicationController.
...
# Deployment - Manages ReplicaSets and provides features like rolling updates and rollback for pod updates.
